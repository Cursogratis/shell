...
#for (( i=1; i<=$Productos; i++)); do
    ...
    while [ $l -eq 0 ]; do
        ...
        while [ $N -eq 0 ]; do
            ...
            read -p '-> ' Name
            read -p "Nota: si quiere ingresar otro valor ingrese 0 " c
            if [ -z $Name ]; then
                echo ""
        ...
        while [ $A -eq 0 ]; do
            ...
            read -p '-> ' can
            read -p "Nota: si quiere ingresar otro valor ingrese 0 " h
            if [ -z ${can} ]; then
                echo ""
            else
                if [[ $can =~ $re ]]; then
        ...
        while [ $B -eq 0 ]; do
            ...
            read -p '-> ' valor
            read -p "Nota: si quiere ingresar otro valor ingrese 0 " m
            if [ -z ${valor} ]; then
                echo ""
            else
                if [[ $valor =~ $re ]]; then
